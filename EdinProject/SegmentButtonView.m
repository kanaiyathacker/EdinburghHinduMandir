...
- (SegmentButtonView *)initWithTitle:(NSString *)title
    ...
    if (self) {
        ...
        self.imageView.frame = CGRectMake(0, -TOP_OFFSET,
                                          80, self.normalImage.size.height);
        ...
        // Set up title
        self.label = [[UILabel alloc] initWithFrame:CGRectMake(0, 4, 80, 20)];
        self.label.backgroundColor = [UIColor clearColor];
        self.label.font = [UIFont fontWithName:@"Helvetica Neue" size:12.5];
        self.label.textColor = [UIColor whiteColor];
        self.label.shadowColor = self.shadowColor;
        self.label.shadowOffset = CGSizeMake(1, 1);
        self.label.textAlignment = UITextAlignmentCenter;
        self.label.text = title;
        self.label.tag = index;
        [self addSubview:self.label];
        
        self.frame = CGRectMake(0,85, 80, normalImage.size.height);
    }
    return self;
}
